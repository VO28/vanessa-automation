...
#Область ГенераторДымовыхТестов      

Функция СформироватьТекстФайлаПоОбъектамМетаданных(Параметры) Экспорт
	...
	Если Текст.КоличествоСтрок() > 0 Тогда
		...
		|@tree
		|
		|Функциональность: Дымовые тесты - " + Параметры.ВидОбъектаМетаданных + " - " + Параметры.ТипТеста + "
