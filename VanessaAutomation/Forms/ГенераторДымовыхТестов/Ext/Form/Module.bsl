...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЗначениеЗаполнено(Объект.ЯзыкШаговДымовыхТестов) Тогда
		ЯзыкШагов = "en";
	Иначе
		ЯзыкШагов = Объект.ЯзыкШаговДымовыхТестов;
	КонецЕсли;
	//ЕстьПараметрыЗапуска = Ложь;
	ТекОбъект = РеквизитФормыВЗначение("Объект");
	
	//// В качестве рабочего каталога будем использовать каталог запуска обработки 
	//Если не ЕстьПараметрыЗапуска Тогда
	//	//КаталогВыходныхФайлов = СтрЗаменить(ТекОбъект.ИспользуемоеИмяФайла, ТекОбъект.Метаданные().Имя + ".epf", ""); 
	//	ПутьПоЧастям = СтрЗаменить(ТекОбъект.ИспользуемоеИмяФайла,"\", Символы.ПС);
	//	ИмяФайлаОбработки = СтрПолучитьСтроку(ПутьПоЧастям, СтрЧислоСтрок(ПутьПоЧастям));
	//	КаталогВыходныхФайлов = СтрЗаменить(ТекОбъект.ИспользуемоеИмяФайла, ИмяФайлаОбработки, "");
	//	КаталогФайловИсключений = КаталогВыходныхФайлов + "ОбъектыИсключения\";		
	//КонецЕсли;  

	КаталогВыходныхФайлов = Объект.КаталогГенерированияДымовыхТестов;
	КаталогФайловИсключений = Объект.КаталогФайловИсключаемыхОбъектовИзДымовогоТестирования;
	ТолькоИзмененные = Объект.ТолькоИзмененныеОтносительноКонфигурацииПоставщикаДляДымовогоТестирования;
	ТолькоВведенные = Объект.ТолькоВведенныеОбъектыДляДымовогоТестирования;
	...
	// Заголовок формы с версией
	//МетаданныеОбработки = ТекОбъект.Метаданные();
	//ЭтаФорма.Заголовок = МетаданныеОбработки.Синоним + " (" + МетаданныеОбработки.Комментарий + ")";
	
	//ТолькоВведенные = Истина;
	
	// Заполним таблицу настроек
	//НСтрокаНастроек = ТаблицаНастроек.Добавить();
	//НСтрокаНастроек.ОбъектМетаданных = "Справочники";
	//НСтрокаНастроек.Картинка = БиблиотекаКартинок.Справочник;
	...
	//
	//НСтрокаНастроек = ТаблицаНастроек.Добавить();
	//НСтрокаНастроек.ОбъектМетаданных = "Документы";
	//НСтрокаНастроек.Картинка = БиблиотекаКартинок.Документ;
	//НСтрокаНастроек.ФормаОбъекта = Истина;
	//НСтрокаНастроек.ФормаСписка = Истина;
	//НСтрокаНастроек.Запись = Истина;
	//НСтрокаНастроек.Копирование = Истина;
	...
	//
	//НСтрокаНастроек = ТаблицаНастроек.Добавить();
	//НСтрокаНастроек.ОбъектМетаданных = "ЖурналыДокументов";
	//НСтрокаНастроек.Картинка = БиблиотекаКартинок.ЖурналДокументов;
	//НСтрокаНастроек.ФормаОбъекта = Истина;
	//
	//НСтрокаНастроек = ТаблицаНастроек.Добавить();
	//НСтрокаНастроек.ОбъектМетаданных = "ПланыВидовХарактеристик";
	//НСтрокаНастроек.Картинка = БиблиотекаКартинок.ПланВидовХарактеристик;
	//НСтрокаНастроек.ФормаОбъекта = Истина;
	//НСтрокаНастроек.ФормаСписка = Истина;
	//НСтрокаНастроек.Запись = Истина;
	//НСтрокаНастроек.Копирование = Истина;
	//
	//НСтрокаНастроек = ТаблицаНастроек.Добавить();
	//НСтрокаНастроек.ОбъектМетаданных = "ПланыСчетов";
	//НСтрокаНастроек.Картинка = БиблиотекаКартинок.ПланСчетов;
	//НСтрокаНастроек.ФормаОбъекта = Истина;
	//НСтрокаНастроек.ФормаСписка = Истина;
	//НСтрокаНастроек.Запись = Истина;
	//
	//НСтрокаНастроек = ТаблицаНастроек.Добавить();
	//НСтрокаНастроек.ОбъектМетаданных = "ПланыВидовРасчета";
	//НСтрокаНастроек.Картинка = БиблиотекаКартинок.ПланВидовРасчета;
	//НСтрокаНастроек.ФормаОбъекта = Истина;
	//НСтрокаНастроек.ФормаСписка = Истина;
	//НСтрокаНастроек.Запись = Истина;
	//НСтрокаНастроек.Копирование = Истина;
	//
	//НСтрокаНастроек = ТаблицаНастроек.Добавить();
	//НСтрокаНастроек.ОбъектМетаданных = "Отчеты";
	//НСтрокаНастроек.Картинка = БиблиотекаКартинок.Отчет;
	//НСтрокаНастроек.ФормаОбъекта = Истина;
	//
	//НСтрокаНастроек = ТаблицаНастроек.Добавить();
	//НСтрокаНастроек.ОбъектМетаданных = "Обработки";
	//НСтрокаНастроек.Картинка = БиблиотекаКартинок.Обработка;
	//НСтрокаНастроек.ФормаОбъекта = Истина;
	//
	//НСтрокаНастроек = ТаблицаНастроек.Добавить();
	//НСтрокаНастроек.ОбъектМетаданных = "РегистрыСведений";
	//НСтрокаНастроек.Картинка = БиблиотекаКартинок.РегистрСведений;
	//НСтрокаНастроек.ФормаОбъекта = Истина;
	//НСтрокаНастроек.ФормаСписка = Истина;
	//
	//НСтрокаНастроек = ТаблицаНастроек.Добавить();
	//НСтрокаНастроек.ОбъектМетаданных = "РегистрыНакопления";
	//НСтрокаНастроек.Картинка = БиблиотекаКартинок.РегистрНакопления;
	//НСтрокаНастроек.ФормаСписка = Истина;
	//
	//НСтрокаНастроек = ТаблицаНастроек.Добавить();
	//НСтрокаНастроек.ОбъектМетаданных = "РегистрыБухгалтерии";
	//НСтрокаНастроек.Картинка = БиблиотекаКартинок.РегистрБухгалтерии;
	//НСтрокаНастроек.ФормаСписка = Истина;
	//
	//НСтрокаНастроек = ТаблицаНастроек.Добавить();
	//НСтрокаНастроек.ОбъектМетаданных = "РегистрыРасчета";
	//НСтрокаНастроек.Картинка = БиблиотекаКартинок.РегистрРасчета;
	//НСтрокаНастроек.ФормаСписка = Истина;
...
//	// "ИмяКонфигурацииПоставщика=УправлениеПредприятием;ТолькоИзмененные;Сформировать;ЗавершитьРаботуСистемы;"
//	
//	Сформировать = Ложь;
//	ЗавершитьРаботуСистемы = Ложь;
//	
//	МассивПараметров = СтрРазделить(ПараметрЗапуска, ";", Ложь);
//	Если МассивПараметров.Количество() Тогда
//		ЕстьПараметрыЗапуска = Истина;
//	КонецЕсли;
//	Для Каждого ЗначениеПараметра Из МассивПараметров Цикл
//		
//		ЗначениеПараметра = СокрЛП(ЗначениеПараметра);
//		
//		Если Найти(ЗначениеПараметра, "КаталогВыходныхФайлов=") Тогда
//			КаталогВыходныхФайлов = СокрЛП(СтрЗаменить(ЗначениеПараметра, "КаталогВыходныхФайлов=", ""));
//		КонецЕсли;		
//				
//		Если Найти(ЗначениеПараметра, "КаталогФайловИсключений=") Тогда
//			КаталогФайловИсключений = СокрЛП(СтрЗаменить(ЗначениеПараметра, "КаталогФайловИсключений=", ""));
//		КонецЕсли;
//		
//		Если Найти(ЗначениеПараметра, "ИмяКонфигурацииПоставщика=") Тогда
//			ИмяКонфигурацииПоставщика = СокрЛП(СтрЗаменить(ЗначениеПараметра, "ИмяКонфигурацииПоставщика=", ""));
//		КонецЕсли;
//		
//		Если ЗначениеПараметра = "ТолькоИзмененные" Тогда
//			ТолькоИзмененные = Истина;
//		КонецЕсли;
//		
//		Если ЗначениеПараметра = "Сформировать" Тогда
//			Сформировать = Истина;
//		КонецЕсли;
//		
//		Если ЗначениеПараметра = "ЗавершитьРаботуСистемы" Тогда
//			ЗавершитьРаботуСистемы = Истина;
//		КонецЕсли;

//		Если Найти(ЗначениеПараметра, "ФайлНастройкиСценариев=") Тогда
//			ФайлНастройкиСценариев = СокрЛП(СтрЗаменить(ЗначениеПараметра, "ФайлНастройкиСценариев=", ""));
//		КонецЕсли;
//		
//	КонецЦикла;
//	
//	Если ЗначениеЗаполнено(ФайлНастройкиСценариев) Тогда
//		Попытка
//			ЗагрузитьНастройкиСценариевЗавершение(Истина, ПоместитьВоВременноеХранилище(Новый ДвоичныеДанные(ФайлНастройкиСценариев)), ФайлНастройкиСценариев, Неопределено)
//		Исключение
//		КонецПопытки;
//	КонецЕсли;
//	
//	Если Сформировать Тогда
//		СформироватьФайлы(Неопределено);
//	КонецЕсли;
//	
...
//	КонецЕсли;
//	
//	ТолькоИзмененныеПриИзменении(Неопределено);
//	
//КонецПроцедуры
...
//	
//	// Если переданы параметры запуска, настройки формы восстанавливать не будем
//	Если ЕстьПараметрыЗапуска Тогда
//		Настройки.Очистить();
//	КонецЕсли;
//	
//КонецПроцедуры
...
Процедура СформироватьФайлыНаКлиенте(ВызовЧерезПараметрЗапуска = Ложь) Экспорт
	...
	Если ВызовЧерезПараметрЗапуска Тогда		
		//GenerateSmokeTest
		Если Не ПустаяСтрока(Объект.ПутьНастройкиСценариеДымовыхТестов) Тогда 
			ЗагрузитьНастройкиСценариевЗавершение(Истина, ПоместитьВоВременноеХранилище(Новый ДвоичныеДанные(Объект.ПутьНастройкиСценариеДымовыхТестов)), Объект.ПутьНастройкиСценариеДымовыхТестов, Неопределено);
		КонецЕсли;	
	КонецЕсли;	
		
	СообщитьПользователю(Локализовать("Начало формирования тестов: ") + ТекущаяДата());
...
Процедура ФормированиеФайловТестов()
	...
	//Если Не ЗапрещеныСинхронныеВызовы() Тогда
	//	ЗаписатьФичаФайлыДымТестов(МассивДанныхФайловДляЗаписи, ВремяНачала);	
	//Иначе
	//	ЗаписатьФичаФайлыДымТестовАснх(МассивДанныхФайловДляЗаписи, ВремяНачала);
	//КонецЕсли;
...
//&НаКлиенте
//Процедура ЗаписатьФичаФайлыДымТестов(МассивДанныхФайловДляЗаписи, ВремяНачала)
//	
//	Для Каждого ТекДанныеФайла Из МассивДанныхФайловДляЗаписи Цикл 
//		ТекДанныеФайла.ТекстФайл.Записать(ТекДанныеФайла.ПутьЗаписи, ТекДанныеФайла.Кодировка); 
//	КонецЦикла;
//	
//КонецПроцедуры 

//&НаКлиенте
//Процедура ЗаписатьФичаФайлыДымТестовАснх(МассивДанныхФайловДляЗаписи, ВремяНачала)
//	Для Каждого ТекДанныеФайла Из МассивДанныхФайловДляЗаписи Цикл            
//		ТекДанныеФайла.ТекстФайл.НачатьЗапись(,ТекДанныеФайла.ПутьЗаписи, ТекДанныеФайла.Кодировка,); 
//	КонецЦикла;
...
Процедура ЗагрузитьНастройкиСценариевИзФайла(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ЗагрузитьНастройкиСценариевЗавершение", ЭтотОбъект);
	НачатьПомещениеФайла(ОписаниеОповещения, АдресФайлаВоВременномХранилище, , , УникальныйИдентификатор);
	
КонецПроцедуры

&НаКлиенте
Процедура ЗагрузитьНастройкиСценариевЗавершение(Результат, Адрес, ВыбранноеИмяФайла, ДополнительныеПараметры) Экспорт
	
	Если Результат Тогда
		
		Состояние(Локализовать("Выполняется настройки сценариев. Пожалуйста, подождите..."));
		
		Файл = Новый Файл(ВыбранноеИмяФайла);
		Если Не Файл.Существует() Тогда
			
			ТекстСообщения = Локализовать("Указанный файл не существует");
			ПутьКДанным = "";
		...
		ЗагрузитьНастройкиСценариевИзФайлаНаСервере(Адрес, Файл.Расширение);
